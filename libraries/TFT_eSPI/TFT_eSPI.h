...
class TFT_eSPI : public Print { friend class TFT_eSprite; // Sprite class has access to protected members
 ...
 public:
  ...
  // void drawRGBBitmap(int32_t x, int32_t y, const uint32_t bitmap[], int32_t w,
  //                    int32_t h);
  // void drawRGBBitmap(int32_t x, int32_t y, uint32_t *bitmap, int32_t w,
  //                    int32_t h);
  // void drawRGBBitmap(int32_t x, int32_t y, const uint32_t bitmap[],
  //                    const uint8_t mask[], int32_t w, int32_t h);
  // void drawRGBBitmap(int32_t x, int32_t y, uint32_t *bitmap, uint8_t *mask,
  //                    int32_t w, int32_t h);
